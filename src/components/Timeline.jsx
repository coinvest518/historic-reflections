...
const timelineData = [
  ...
  { date: '600 BCE', event: 'Nok civilization flourishes in West Africa', region: 'Nigeria', top: true },
  { date: '300 CE', event: 'Kingdom of Mali founded', region: 'Mali', top: false },
  { date: '750 CE', event: 'Timbuktu established as center of learning', region: 'West Africa', top: true },
